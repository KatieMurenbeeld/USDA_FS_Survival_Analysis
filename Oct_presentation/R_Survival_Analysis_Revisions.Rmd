...
setwd("/Users/kathrynmurenbeeld/Desktop/Desktop - Kathryn’s MacBook Pro/Survival_Analysis/Oct_presentation/")
...
#overlap + geom_point()
plot(df_fin$overlap, df_fin$proj.delay)
...
plot(df_fin$act.count, df_fin$proj.delay)
plot(df_fin$hf, df_fin$proj.delay)
...
cox.cat_treat <- coxph(Surv(proj.delay, INITIATED) ~ hf, data=df_fin)
